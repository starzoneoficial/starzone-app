    ...
    switch (type) {
        ...
        case "list":
            ...
            document.getElementById("changeMasterPassword").addEventListener("click", () => {
                ipcRenderer.send('userChangeMasterPassword', null);
            });
        ...
        case "editUser":
            ...
            break;
        case "changeRegisterMaster":
            document.getElementById("form").onsubmit = (sub) => {
                sub.preventDefault();
                let oldpasword = document.getElementById("oldpassword").value;
                let newpasword = document.getElementById("newpassword").value;

                ipcRenderer.send('checkMasterRegister', [oldpasword, newpasword]);
...
ipcRenderer.on("messageToAlert", function(event, message) {
    alert(message);
});
